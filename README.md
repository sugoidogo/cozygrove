...
This repo is a template for creating a [packwiz](https://packwiz.infra.link/) modpack an auto-updating prism launcher modpack using Github Actions to push updates to Github Pages and Releases.
## Usage
